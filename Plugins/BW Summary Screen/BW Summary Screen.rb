...
def pbDisplayIVRating
   ...
   #HP	
    ...
    #SpAtk	
    if @pokemon.iv[:SPECIAL_ATTACK]>30	
    ...
    #SpDef	
    if @pokemon.iv[:SPECIAL_DEFENSE]>30	
...
#=============================================================================
  ...
  def drawPageOne
    ...
    if @pokemon.shadowPokemon?
      ...
      drawFormattedTextEx(overlay,16,296,264,memo)
    else
    ...
    if @pokemon.level<GameData::GrowthRate.max_level
      ...
      pbDrawImagePositions(overlay,[
         ["Graphics/Pictures/Summary/overlay_exp",140,358,0,0,w,6]
      ])
	  else
	  pbDrawImagePositions(overlay,[
         ["Graphics/Pictures/Summary/overlay_exp",140,360,0,0,w,6]
      ])
	  end
    end
  end
...
if SHOW_EV_IV
    ...
    if @pokemon.hp>0
	  ...
	  if SHOW_EV_IV==true
      imagepos = [
         ["Graphics/Pictures/Summary/overlay_hp",190,112,0,hpzone*6,w,6]
      ]
	  else
	  imagepos = [
		 ["Graphics/Pictures/Summary/overlay_hp",168,112,0,hpzone*6,w,6]
      ]
	  end
      pbDrawImagePositions(overlay,imagepos)
    end
  ...
  def drawPageFourSelecting(move_to_learn)
    ...
    for i in 0...limit
      ...
      if move
        ...
        textpos.push([move.name,328,yPos,0,moveBase,moveShadow])
        if move.total_pp>0
  ...
  def drawSelectedRibbon(ribbonid)
	...
	if SUMMARY_B2W2_STYLE
    imagepos = [
       ["Graphics/Pictures/Summary/overlay_ribbon_B2W2",0,280]
    ]
	else
	imagepos = [
